...
3. **Run BuildAll.cmd:**
   - Run the BuildAll.cmd (no NOT the ps1) file in the script location of the repository. This will use the ps1 to compile the browser, compile the newtab, and compile the installer.
4. **Done**
